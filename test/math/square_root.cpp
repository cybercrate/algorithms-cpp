...
TEST(algorithms_math, square_root_1) {
    auto x = wingmann::algorithms::math::square_root(262'144);
...
TEST(algorithms_math, square_root_2) {
    auto x = wingmann::algorithms::math::square_root(2'126'781.656f);
...
TEST(algorithms_math, square_root_3) {
    auto x = wingmann::algorithms::math::square_root(35'611.289);
